...
export class AuthService {
  ...
  constructor(public router: Router, public http: HttpClient, public zone: NgZone, private storage: Storage, private safariViewController: SafariViewController, public events: Events) {
